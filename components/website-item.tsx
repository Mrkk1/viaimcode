...
import { Trash2, ExternalLink, Copy, Loader2 } from 'lucide-react';
...
export function WebsiteItem({ website, onDelete }: WebsiteItemProps) {
  ...
  return (
    <>
      <div className="group relative border border-gray-800/30 rounded-xl p-4 transition-all duration-300 bg-gray-900/90 hover:bg-gray-800/90 backdrop-blur-sm  hover:shadow-lg hover:shadow-gray-900/20">
